...
public class SkuVaultAccountForManipulationDtoValidator<T> : AbstractValidator<T> where T : SkuVaultAccountForManipulationDto
{
    public SkuVaultAccountForManipulationDtoValidator()
    {
