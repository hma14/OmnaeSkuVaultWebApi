...
public class SkuVaultTokenForManipulationDtoValidator<T> : AbstractValidator<T> where T : SkuVaultTokenForManipulationDto
{
    public SkuVaultTokenForManipulationDtoValidator()
    {
