namespace OmnaeSkuVaultWebApi.Databases.EntityConfigurations;

using OmnaeSkuVaultWebApi.Domain.SkuVaultAccounts;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Metadata.Builders;

public class SkuVaultAccountConfiguration : IEntityTypeConfiguration<SkuVaultAccount>
{
    /// <summary>
    /// The database configuration for SkuVaultAccounts. 
    /// </summary>
    public void Configure(EntityTypeBuilder<SkuVaultAccount> builder)
    {
